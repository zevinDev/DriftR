...
create: function()
{
    ...
    var player1 = this.physics.add.sprite(200,600, 'player1');
    player1.setInteractive();
        player1.on(Phaser.Input.Events.GAMEOBJECT_POINTER_DOWN, () => {
            mainPlayer = this.load.image('player1')
        })
    var player2 = this.physics.add.sprite(400,600, 'player2');
    player2.setInteractive();
        player2.on(Phaser.Input.Events.GAMEOBJECT_POINTER_DOWN, () => {
        mainPlayer = this.load.image('player2')
    })
